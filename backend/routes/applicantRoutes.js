...
router.post("/api/submit-documents", upload.array('files'), applicantController.fileSubmit);
router.get("/api/fetch-documents", applicantAuthMiddleware, applicantController.fileFetch);
...
router.get("/api/profile/:id", applicantAuthMiddleware, applicantController.profileId);
