...
router.use(express.static(path.join(__dirname, "../../frontend/client/applicant")));
router.use(express.static(path.join(__dirname, "../../frontend/client/applicant/home")));
router.use(express.static(path.join(__dirname, "../../frontend/client/applicant/login")));
